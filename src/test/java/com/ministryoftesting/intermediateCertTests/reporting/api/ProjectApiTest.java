package com.ministryoftesting.intermediateCertTests.reporting.api;
...
public class ProjectApiTest {
    ...
    public void setupLogging(TestInfo testInfo) throws IOException {
        FileWriter fileWriter = new FileWriter("target/allure-results/" + testInfo.getDisplayName() + ".log");
    ...
    public void addLogToAllure(TestInfo testInfo) throws IOException {
        String log = new String(Files.readAllBytes(Paths.get("target/allure-results/" + testInfo.getDisplayName() + ".log")));
