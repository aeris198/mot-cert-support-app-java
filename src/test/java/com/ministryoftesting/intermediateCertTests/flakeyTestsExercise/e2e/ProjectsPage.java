...
public class ProjectsPage {
    ...
    @FindBy(how = How.CSS, using = "#root > div > div.row.mt-2 > div.col-8 > div > div > h2")
    ...
    public ProjectsPage(WebDriver driver) {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#root > div > div.row.mt-2 > div.col-8 > div > div > h2")));
    }
